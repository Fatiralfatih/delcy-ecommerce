    ...
    <div className="bg-white p-4 text-lg rounded-xl w-full lg:basis-[70rem] xl:max-w-md xl:basis-[80rem]">
      ...
      <article className=" space-y-3">
        ...
        <div className="flex gap-2">
          <span className="text-sm py-[5px] px-3 rounded-lg bg-zinc-200  hover:bg-success-500 text-zinc-950 cursor-pointer">
            S
          </span>
          <span className="text-sm py-[5px] px-3 rounded-lg bg-zinc-200  hover:bg-success-500 text-zinc-950 cursor-pointer ">
            M
      ...
      <article className=" space-y-3">
        ...
        <div className="flex gap-2">
          <span className="text-sm p-4 rounded-full bg-red-600 cursor-pointer" />
          <span className="text-sm p-4 rounded-full bg-blue-600 cursor-pointer" />
          <span className="text-sm p-4 rounded-full bg-indigo-600 cursor-pointer" />
          <span className="text-sm p-4 rounded-full bg-green-600 cursor-pointer" />
        </div>
      </article>
